...
//			e.printStackTrace();
    	...
    	try
		{
			...
			List <VOCliente> lista = parranderos.darVOClientes();
			assertEquals ("No debe haber tipos de bebida creados!!", 0, lista.size ());

			// Lectura de los tipos de bebida con un tipo de bebida adicionado
			String nombreTipoBebida1 = "Vino tinto";
			VOCliente Cliente1 = parranderos.adicionarTipoBebida (nombreTipoBebida1);
...
//			e.printStackTrace();
		...
		try
		{
			...
			// Lectura de los tipos de bebida con un tipo de bebida adicionado
			String nombreCliente1 = "Andres Suarez";
			VOCliente tipoCliente1 = parranderos.adicionarCliente (nombreTipoBebida1);
			lista = parranderos.darVOTiposBebida();
			assertEquals ("Debe haber un tipo de bebida creado !!", 1, lista.size ());
